...
std::string g_lidar_path;
std::string g_save_path;

void read_config(
  ros::NodeHandle & nh)
{
  nh.param<std::string>("lidar_path", g_lidar_path, "/data/datasets/dataset_std/park_avia/park2.bag");
  nh.param<std::string>("save_path", g_save_path, "/data/datasets/dataset_std/park_avia_02");
  ...
  const std::string& filename)
{
  ...
  std::cout << "Saved PCD file: " << filename << std::endl;
}
